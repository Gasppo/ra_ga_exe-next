export const updateProcessResourcesHTML = (data: { name: string, orderId: string, processName: string }) => {
    return `
    <!DOCTYPE html>
        <html lang="en">
    ...
    <div style="background-color: midnightblue;padding:1rem; border-radius: 0.5rem;margin:4rem;">
        <div style="background-color: white;padding:2rem;box-shadow: 5px 5px 20px slategray; border-radius: 0.5rem;">
            ...
            <div style="color:dimgray">
                <p>Se han asignado nuevos recursos al proceso de <em>${data.processName}</em> para la orden <em>${data.orderId}</em></b></p>
