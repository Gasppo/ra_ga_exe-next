...
function Horizontal<Model>(props: VerticalProps<Model>) {
    ...
    return (
        <>
            ...
            <Grid wrap={wrap ? 'wrap' : 'nowrap'} justifyContent={props?.layout?.justifyContent} alignItems={'center'} spacing={props.layout.spacing || 1} container direction="row" className={clsx(props.layout.className, { [`${props.layout.divider}:divide-x divide-gray-200`]: props.layout.divider })}>
