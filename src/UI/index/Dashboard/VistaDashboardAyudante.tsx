...
const VistaDashboardAyudante = (props: props) => {
    ...
    const ayudanteColumns = useMemo((): GridColumns<ExtendedOrdenData> => ([
        { field: 'link', headerName: 'Ver', minWidth: 50, disableColumnMenu: true, filterable: false, sortable: false, renderCell: (params) => <Link href={`/orden/${params.row.id}`}><LaunchIcon /></Link>, },
